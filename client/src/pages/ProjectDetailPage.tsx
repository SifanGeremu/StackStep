  ...
  const loadProject = async () => {
    ...
    try {
      ...
      const mockProject: ProjectDetail = {
        ...
        description:
          'Learn full-stack web development by building a feature-rich blog application using the MERN stack.',
        phases: [
          {
            id: 'phase_1',
            ...
            tasks: [
              {
                ...
                description:
                  'Install Node.js and npm on your machine. Learn about package management.',
                expectedOutcome:
                  'Node.js and npm installed, verified with `node -v` and `npm -v`',
              },
              {
                id: 'task_2',
                title: 'Create Express server',
                description:
                  'Initialize a new Node project and create a basic Express server.',
                expectedOutcome:
                  'Server running on http://localhost:5000 with a hello world route',
              },
              {
                id: 'task_3',
                title: 'Setup MongoDB connection',
                description: 'Connect your Express app to MongoDB Atlas or local MongoDB.',
                expectedOutcome: 'MongoDB connected and verified in console logs',
              },
            ],
          },
          {
            ...
            tasks: [
              {
                id: 'task_4',
                title: 'Create Blog Post Model',
                description:
                  'Design and create a MongoDB schema for blog posts using Mongoose.',
                expectedOutcome:
                  'Mongoose model with title, content, author, and timestamps',
              },
              {
                id: 'task_5',
                title: 'Create CRUD Routes',
                description:
                  'Build API endpoints for Create, Read, Update, and Delete blog posts.',
                expectedOutcome:
                  'All CRUD endpoints working in Postman/Insomnia with proper error handling',
              },
              {
                id: 'task_6',
                ...
                expectedOutcome: 'Users can register, login, and receive JWT tokens',
              },
            ],
          },
          {
            id: 'phase_3',
            title: 'Phase 3: Build React Frontend',
            description: 'Create the user interface for your blog',
            tasks: [
              {
                id: 'task_7',
                title: 'Setup React with Vite',
                description: 'Initialize a new React project using Vite for faster development.',
                expectedOutcome:
                  'React app running on http://localhost:5173 with Vite dev server',
              },
              {
                id: 'task_8',
                title: 'Create Blog Post List Component',
                description:
                  'Build a component that fetches and displays all blog posts from your API.',
                expectedOutcome:
                  'List of blog posts displayed on the page, fetched from API',
              },
              {
                id: 'task_9',
                title: 'Build Single Post View',
                description:
                  'Create a detailed view page for individual blog posts with routing.',
                expectedOutcome: 'Single post page showing full content when clicked',
              },
            ],
          },
          {
            ...
            description: 'Polish and enhance your application',
            tasks: [
              {
                id: 'task_10',
                title: 'Add Comments System',
                description:
                  'Implement a commenting system where users can comment on posts.',
                expectedOutcome: 'Comments appearing below posts in real-time',
              },
              {
                id: 'task_11',
                title: 'Deploy to Production',
                description:
                  'Deploy your backend to Heroku/Railway and frontend to Vercel/Netlify.',
                expectedOutcome:
                  'Live blog application accessible at a public URL',
              },
            ],
          },
        ],
      ...
      setExpandedPhase(mockProject.phases[0]?.id || null)
    } catch (err) {
